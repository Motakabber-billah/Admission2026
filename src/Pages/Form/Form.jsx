                    ...
                    <div>
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            ...
                            <div className="flex flex-col items-start gap-2 mb-3">
                                <span className="label-text text-base md:text-xl">নাম <span className="text-red-700">*</span></span>
                                <input type="text" name="name" placeholder="নাম লিখুন" className="input input-bordered input-success w-full" required />
                            </div>

                            {/*  জন্ম তারিখ*/}
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/3">
                                    <span className="label-text text-base md:text-xl">জন্ম তারিখ <span className="text-red-700">*</span></span>
                                    <input type="date" name="dob" placeholder="জন্ম তারিখ লিখুন" className="input input-bordered input-success w-full" required />
                                </div>

                                {/*জন্ম নিবন্ধনের নম্বর  */}
                                <div className="flex flex-col md:flex-row gap-2 w-full md:w-2/3">
                                    <span className="label-text text-base md:text-xl">জন্ম নিবন্ধনের নম্বর <span className="text-red-700">*</span></span>
                                    <input type="number" name="brn" placeholder="জন্ম নিবন্ধনের নম্বর লিখুন" className="input input-bordered input-success w-full" required />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row w-ful gap-5 mb-5">
                                ...
                                <div className="w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">শিক্ষার্থীর ধরণ/জেন্ডার <span className="text-red-700">*</span></span>
                                    <span><TextDropdownGender></TextDropdownGender></span>
                                </div>

                                {/* শিক্ষার্থীর ধর্ম */}
                                <div className="w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">শিক্ষার্থীর ধর্ম <span className="text-red-700">*</span></span>
                            ...
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                ...
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">মোবাইল নম্বর <span className="text-red-700">*</span></span>
                                ...
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">মোবাইল নম্বরটি আবার লিখুন <span className="text-red-700">*</span></span>
                        ...
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            <h2 className="text-[14px] md:text-[18px] text-red-600 text-center mb-4">পিতা এবং মাতা বর্তমান থাকলে অভিভাবকের তথ্য প্রয়োজন নাই। তবে, পিতা অথবা মাতার অবর্তমানে অভিভাবকের তথ্য বাধ্যতামূলক।</h2>
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">

                                {/* পিতার নাম */}
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">পিতার নাম <span className="text-red-700">*</span></span>
                                ...
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">পিতার এনআইডি/জন্ম নিবন্ধন/পাসপোর্ট নম্বর <span className="text-red-700">*</span></span>
                            ...
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                ...
                                {/* মাতার নাম */}
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">মাতার নাম <span className="text-red-700">*</span></span>
                                ...
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">মাতার এনআইডি/জন্ম নিবন্ধন/পাসপোর্ট নম্বর <span className="text-red-700">*</span></span>
                            ...
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                ...
                                {/* অভিভাবকের নাম */}
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">অভিভাবকের নাম</span>
                                ...
                                <div className="flex flex-col items-start gap-2 w-full md:w-1/2">
                                    <span className="label-text text-base md:text-xl">অভিভাবকের এনআইডি/জন্ম নিবন্ধন/পাসপোর্ট নম্বর </span>
                        ...
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                ...
                                <div className="flex flex-col items-start gap-2 w-full">
                                    <span className="label-text text-base md:text-xl">শ্রেণি<span className="text-red-700">*</span></span>
                        ...
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            <div className="flex flex-col md:flex-row w-full gap-5 mb-5">
                                ...
                                <div className="flex flex-col items-start gap-2 w-full">
                                    <span className="label-text text-base md:text-xl">পূর্বে অধ্যয়নকৃত বিদ্যালয়ের নাম<span className="text-red-700">*</span></span>
                                ...
                                <div className="flex flex-col items-start gap-2 w-full">
                                    <span className="label-text text-base md:text-xl">পূর্বে অধ্যয়নকৃত শ্রেণি<span className="text-red-700">*</span></span>
                        ...
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            ...
                            <div className="flex flex-col w-full gap-5 mb-5">
                                <div className="flex flex-col items-start gap-2 w-full">
                                    ...
                                    <span className="label-text text-base md:text-xl">বিস্তারিত ঠিকানা<span className="text-red-700">*</span></span>
                                ...
                                <div className="flex flex-col md:flex-row gap-2">
                                    <div className="flex flex-col items-start gap-2 w-full md:w-1/4">
                                        <span className="label-text text-base md:text-xl">জেলার নাম <span className="text-red-700">*</span></span>
                                        <input type="text" name="division" placeholder="জেলার নাম লিখুন" className="input input-bordered input-success w-full" required />
                                    </div>
                                    <div className="flex flex-col items-start gap-2 w-full md:w-1/4">
                                        <span className="label-text text-base md:text-xl">উপজেলার নাম <span className="text-red-700">*</span></span>
                                        <input type="text" name="district" placeholder="উপজেলার নাম লিখুন" className="input input-bordered input-success w-full" required />
                                    </div>
                                    <div className="flex flex-col items-start gap-2 w-full md:w-1/4">
                                        <span className="label-text text-base md:text-xl">থানার নাম <span className="text-red-700">*</span></span>
                                        <input type="text" name="thana" placeholder="থানার নাম লিখুন" className="input input-bordered input-success w-full" required />
                                    </div>
                                    <div className="flex flex-col items-start gap-2 w-full md:w-1/4">
                                        <span className="label-text text-base md:text-xl">পোস্ট কোড <span className="text-red-700">*</span></span>
                        ...
                        <div className="border border-orange-400 rounded-lg p-4 mt-5 mb-6">
                            ...
                            <div className="flex flex-col w-full gap-5 mb-5">
                                <div className="flex flex-col items-start gap-2 w-full">
                                    <span className="text-base md:text-xl">স্থায়ী ঠিকানা</span>
                                    <span className="label-text text-base md:text-xl">বিস্তারিত ঠিকানা<span className="text-red-700">*</span></span>
                                    <input type="text" name="addressLine1" placeholder="এখানে জেলা এবং থানা লেখার প্রয়োজন নাই।" className="input input-bordered input-success w-full" required />
                                </div>
                                <div className="flex flex-col md:flex-row gap-2">
                            ...
                            <div className=" bg-base-200">
                                <div className="flex flex-col lg:flex-row w-full p-4">
                                    <div className="w-full md:w-1/2 flex flex-col justify-center">
                                        <h2 className="text-xl md:text-2xl text-center mb-3">প্রার্থীর ছবি</h2>
